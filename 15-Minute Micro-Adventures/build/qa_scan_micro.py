"""QA scanner for 15-Minute Micro-Adventures (PyMuPDF).

Two checks (this template has no draw/canvas zone to protect), exit code 1
if any fails:
...
PDF = "../15-minute-micro-adventures_v1.0_letter.pdf"
